...
const CompaniesPage: React.FC = () => {
  const benefits = [
    ...
    {
      icon: 'fas fa-user-check text-secondary',
    ...
    {
      icon: 'fas fa-palette text-accent',
                ...
                <div className="md:w-3/4">
                  ...
                  {step.example && (
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                      <h4 className="font-medium text-sm text-gray-500 mb-2">Example:</h4>
                  ...
                  {step.number === 3 && (
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 flex flex-col sm:flex-row gap-4">
                      ...
                      <div className="flex-grow flex flex-wrap gap-1">
                        <span className="px-2 py-0.5 bg-green-100 text-green-800 rounded text-xs">98% UI Design</span>
                        <span className="px-2 py-0.5 bg-green-100 text-green-800 rounded text-xs">95% Mobile</span>
                        <span className="px-2 py-0.5 bg-green-100 text-green-800 rounded text-xs">90% Figma</span>
                        <span className="px-2 py-0.5 bg-yellow-100 text-yellow-800 rounded text-xs">75% Finance</span>
                      </div>
                      <Button variant="link" className="text-primary text-sm font-medium whitespace-nowrap">View Portfolio</Button>
                    </div>
                  )}
                </div>
              </div>
